...
namespace Ergo.Tests
{
    public class ResultTests
    {
        ...
        public void OnSuccess_ResultOfT_ChainedSuccess()
        {
            ...
            Assert.True(result.IsSuccessful);
            Assert.Equal("string", result.GetSuccessValueOrDefault("defaultValue"));
        }
        ...
        {
            var result = Result.Failure()
                .OnFailure((r) => Result.Failure<string>("string"));
        ...
        public void OnFailure_ResultOfT_SuccessStopsPipeline()
        {
            var result = Result.Failure()
                .OnFailure((r) => Result.Success())
                .OnFailure((r) => Result.Failure<string>());
        ...
        public async Task OnFailure_TaskResult_ChainedFailure()
        {
            var result = await Result.Failure()
                .OnFailure((r) => Task.FromResult(Result.Failure()));
        ...
        {
            var result = await Result.Failure()
                .OnFailure((r) => Task.FromResult(Result.Failure<string>("string")));
        ...
        public async Task OnFailure_Task_ResultOfT_SuccessStopsPipeline()
        {
            var result = await Result.Failure()
                .OnFailure((r) => Result.Success())
                .OnFailure((r) => Task.FromResult(Result.Failure<string>()));
